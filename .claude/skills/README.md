...
### nextjs-shadcn-reactflow
**Purpose:** Configure a Next.js App Router project pairing shadcn/ui, Tailwind CSS, TypeScript strict mode, and React Flow builders.

**Files:** 1 main file + 5 resource files (project setup, UI patterns, React Flow integration, mock app workflow, tooling/testing).

**Covers:**
- Bootstrap commands for create-next-app + shadcn CLI
- Tailwind token strategy and shadcn component conventions
- React Flow canvas structure, persistence, collaboration, and performance
- End-to-end mock app workflow for validating the stack locally
- QA stack with Vitest, Playwright, Storybook, git hooks

**Use when:**
- Starting a Next.js dashboard with visual flow editors
- Integrating shadcn/ui into an App Router project
- Wiring React Flow with server actions and React Query
- Establishing testing + automation for the builder experience

**Customization:** ⚠️ Update `pathPatterns` in `skill-rules.json` to match your Next.js directories (`src/app`, `app`, `components`).

**[View Skill →](nextjs-shadcn-reactflow/)**
